namespace Holidays_Between_Two_Dates
{
    ...
    public class Startup
    {
        public static void Main()
        {
             ...
             * You should trace the program execution 
             * to find the lines of code that produce incorrect or unexpected results.
             * You are given a program (existing source code) that aims to count the non-working days 
             * between two dates given in format day.month.year 
